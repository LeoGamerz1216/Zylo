...
const chunks = computed(() => [
  ...
  },
  {
    ...
    title: t('About.Help'),
    content: [
      `<a href="https://docs.zylo.app/">${t('About.Zylo Wiki')}</a>`,
      `<a href="https://docs.zylo.app/faq/">${t('About.FAQ')}</a>`,
  ...
  },
  {
    ...
    content: '<a href="https://zylo.app/">https://zylo.app/</a>',
  },
  {
    icon: ['fas', 'envelope'],
    title: t('About.Email'),
  ...
  },
  {
    ...
    content: [
      '<a href="https://matrix.to/#/#zylo:matrix.org">#zylo:matrix.org</a>',
      t('About.Please read the {roomRulesLink}', {
        roomRulesLink: `<a href="https://docs.zylo.app/community/matrix/">${t('About.room rules')}</a>`,
      }),
    ].join('<br>'),
  },
  {
    ...
    content: '<a href="https://hosted.weblate.org/engage/zylo/">https://hosted.weblate.org/engage/zylo/</a>',
  },
  {
    icon: ['fas', 'users'],
    title: t('About.Credits'),
    content: t('About.Zylo is made possible by {creditsPageLink}', {
      creditsPageLink: `<a href="https://docs.zylo.app/credits/">${t('About.these people and projects')}</a>`,
    }),
  },
  {
    icon: ['fab', 'bitcoin'],
