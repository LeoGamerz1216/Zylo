...
function openDownloadsPage() {
  openExternalLink('https://zylo.app#download')
 ...
 * Cancels the drag operation if the URL is Zylo specific and cannot be transformed e.g. user playlist URLs
...
function handleDragStart(event) {
  ...
  if (transformed) {
    ...
    // Cancel the drag operation for Zylo specific URLs that cannot be transformed such as user playlist URLs
    event.preventDefault()
